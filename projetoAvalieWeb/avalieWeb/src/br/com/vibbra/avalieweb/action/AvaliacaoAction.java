...
@Name("avaliacaoAction")
@Scope(ScopeType.CONVERSATION)
public class AvaliacaoAction extends GenericAction {

	private static final long serialVersionUID = 1L;
	
	private static final String LISTAR_AVALIACAO = "listarAvaliacao";
	private static final String ADICIONAR_AVALIACAO = "adicionarAvaliacao";
	private static final String EDITAR_AVALIACAO = "editarAvaliacao";
	...
	public String pesquisar(){
		try{
			avaliacaoLista = avaliacaoBusiness.findAll();
	...
	public String salvar() {
		String retorno = LISTAR_AVALIACAO;
		try {
